...
function Index() {
    ...
    const [ filter, setFiter ] = useState("incomplete");
   ...
   return (
    <IndexLayout filter={filter} setFilter={setFiter} setSearchText={searchText}>
        <IndexMain setTodoList={setTodoList} todoList={filterTodoList}/>
    </IndexLayout>
   )
}
